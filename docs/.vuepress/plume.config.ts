...
export default defineThemeConfig({
 logo: '/plume.svg',           // 浅色模式导航栏 logo
  ...
  footer: {
    ...
    copyright: '© 2026 墨染残阳 | <span class="icp-icon-xvzk"></span> <a href="https://beian.miit.gov.cn/" target="_blank" style="color: var(--vp-c-text-2); font-size: 1em; font-weight: bold; text-decoration: none;">豫ICP备2025113230号-2</a>',          // ← 第二行版权文字（可选）
  },
